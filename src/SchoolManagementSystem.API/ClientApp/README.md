...
Open [https://localhost:44441](https://localhost:44441) to view it in the browser.
...
In the WebStorm menu `Run` select `Edit Configurations...`. Then click `+` and select `JavaScript Debug`. Paste `https://localhost:44441` into the URL field and save the configuration.
...
```
Fetch API cannot load https://localhost:4000/api/todos. No 'Access-Control-Allow-Origin' header is present on the requested resource. Origin 'https://localhost:44441' is therefore not allowed access. If an opaque response serves your needs, set the request's mode to 'no-cors' to fetch the resource with CORS disabled.
```
